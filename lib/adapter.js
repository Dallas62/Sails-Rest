...
module.exports = (function () {
  ...
  function errorHandler( onSuccess, callback ) {
    ...
    return function( data, response ) {
      ...
      if ( response && ( response.statusCode === 200 || response.statusCode === 201 ) ) {
        ...
        return callback( new RestError('No connection to host.') );
      } else {
    ...
    find: function ( connection, collection, options, cb ) {
      ...
      setTimeout( function() {
        ...
        rest.get(
          url,
          conn.generateArgs()
        ).on('complete', errorHandler( function( data ) {
          ...
          _.forEach( data, function( value ) {
            ...
            calls.push( function( callback ) {
              ...
              rest.postJson(
                ...
                values,
                conn.generateArgs()
              ).on('complete', errorHandler( function( res ) {
          ...
          _.forEach( data, function( value ) {
            ...
            calls.push( function( callback ) {
              ...
              rest.del(
                url + id,
                conn.generateArgs()
              ).on('complete', errorHandler( function() {
    ...
    custom: function ( connection, collection, options, cb ) {
      ...
      setTimeout( function() {
        ...
        if ( request ) {
          ...
          request.on('complete', errorHandler( function ( data ) {
